# Botson-Discord bot with openai api - can write inside threads and remember some earlier context of conversations, in channels call the bot with @thebotsname
